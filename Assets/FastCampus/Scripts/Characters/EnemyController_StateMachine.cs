...
namespace FastCampus.Characters
{
    public class EnemyController_StateMachine : EnemyController
    {
        ...
        protected StateMachine<EnemyController> stateMachine; //스테이트 머신 추가
        ...
        protected override void Start()
        {
            ...
            stateMachine = new StateMachine<EnemyController>(this, new IdleState());//처음 idle상태로 초기화
        ...
        override public Transform SearchEnemy()
        {
            ...
            Collider[] targetsInViewRadius = Physics.OverlapSphere(transform.position, viewRadius, targetMask); //원안에 들어오는거 인식만들기
